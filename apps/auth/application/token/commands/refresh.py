...
from auth.application.token.dto import (
...
if TYPE_CHECKING:
    # Services (연주자)
    # Ports (인프라)
    from auth.application.common.ports import TransactionManager
    from auth.application.token.ports import BlacklistEventPublisher
